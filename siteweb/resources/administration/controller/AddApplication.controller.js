sap.ui.define(["camelot/smartcontract/administration/controller/BaseController", "sap/m/MessageToast"],
	function (BaseController, MessageToast) {
		...
		return BaseController.extend("camelot.smartcontract.administration.controller.AddApplication", {
			...
			onBtnAdd: function (oEvent) {
				...
				var applicationData = this.getView().getModel().getData().application;
				...
				if (actionType === "Add") {
					...
					var error = function (err) {
						jQuery.sap.log.error("Could not add the application " + err);
						MessageToast.show("Application cannot be added. Please refer log for more info.");
					}.bind(this);

					this.createNewApplication(applicationData, success, error);
